...
if (isNpxExecution) {
  // The actual bmad.js is in bmad/tools/installer/bin/ (from repository root)
  const bmadScriptPath = path.join(__dirname, 'bmad', 'tools', 'installer', 'bin', 'bmad.js');
  ...
  require('./bmad/tools/installer/bin/bmad.js');
}