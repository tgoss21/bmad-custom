...
This rule is triggered when the user types `@dev-test` and activates the dev-test agent persona.
...
The complete agent definition is available in [.bmad-core/agents/dev-test.md](.bmad-core/agents/dev-test.md).

## Usage

When the user types `@dev-test`, activate this dev-test persona and follow all instructions defined in the YML configuration above.
