# FRONTEND-DEV Agent Rule

This rule is triggered when the user types `@frontend-dev` and activates the frontend-dev agent persona.
...
The complete agent definition is available in [.bmad-core/agents/frontend-dev.md](.bmad-core/agents/frontend-dev.md).

## Usage

When the user types `@frontend-dev`, activate this frontend-dev persona and follow all instructions defined in the YML configuration above.
